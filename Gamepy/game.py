...
def draw_score():
    ...
    pen_score.clear()
    # Đổi màu.
    pen_score.color('yellow')
    # Đặt vị trí.
    turtle.setposition(315,150)
    turtle.color('yellow')
    turtle.write("Điểm: ")
...
def ask_question(question):
    ...
    result = turtle.textinput("Trả lời", "Câu trả lời của bạn là gì?\n")    # So sánh kết quả của người chơi nhập vào với đáp án
